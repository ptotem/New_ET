...
ActiveRecord::Schema.define(:version => 20131119091434)  do
  ...
  create_table "bonus_quizzes", :id => false, :force => true do |t|
    t.integer "question_id"
    t.integer "bonus_id"
  end
  ...
  create_table "promotions_questions", :force => true do |t|
  ...
  create_table "questions", :force => true do |t|
    ...
    t.string   "view_article_file_name"
    t.string   "view_article_content_type"
    t.integer  "view_article_file_size"
    t.datetime "view_article_updated_at"
  end
  ...
  create_table "users", :force => true do |t|
    ...
    t.integer  "successful_reference",      :default => 0
    ...
    t.integer  "refer_score",               :default => 0
  end
  ...
  create_table "week_winners", :force => true do |t|
    t.integer  "user_id"
    t.integer  "points"
    t.integer  "year"
    t.integer  "week_no"
